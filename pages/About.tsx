    ...
    <div className="bg-white">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="prose prose-lg prose-headings:font-serif prose-headings:text-brand-900 prose-p:text-gray-600 mx-auto">
          ...
          <p>
            Sou esposa, mãe de três filhos incríveis e apaixonada por tudo que envolve cozinha. Minha jornada começou há muitos anos, observando minha avó e minha mãe transformarem ingredientes simples em momentos inesquecíveis à mesa.
          </p>
          <p>
            Lembro-me de subir no banquinho para alcançar a pia e ajudar a enrolar brigadeiros. A cozinha sempre foi o coração da nossa casa, o lugar onde as conversas aconteciam, onde as lágrimas secavam com um pedaço de bolo quente e onde celebrávamos as pequenas vitórias da vida.
          </p>
          <p>
